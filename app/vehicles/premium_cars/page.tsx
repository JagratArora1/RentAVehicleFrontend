...
//       <h1 className="text-3xl font-bold text-center my-5"></h1>
//       <motion.div
...
//       try {
//         const res = await apiRequest("vehicles/category/premium", "GET");
//         setVehicles(res);
//         // Fetch vehicle documents
//         const res2 = await apiRequest("admin/vehicle-documents/vehicle/5", "GET");
